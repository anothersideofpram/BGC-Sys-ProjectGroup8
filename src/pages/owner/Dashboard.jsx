        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">Tren 6 bulan terakhir</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">Ringkasan metrik pelanggan</p>
            </div>
          ...
          {/* Mini Stats */}
            ...
            <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
              <div className="h-1.5 bg-gradient-to-r from-pink-400 to-rose-400" style={{ width: "68%" }} />
            </div>
            <div className="flex justify-between items-center text-sm">
            ...
            <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
              <div className="h-1.5 bg-gradient-to-r from-blue-400 to-cyan-400" style={{ width: "28%" }} />
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div>
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="font-bold text-green-600">Rp 12.450.000</span>
              </div>
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div className="h-2 bg-gradient-to-r from-green-400 to-emerald-400" style={{ width: "85%" }} />
              </div>
            </div>
