...
const customerMetrics = [
  { label: "Total Pelanggan", value: "1,240", color: "#e91e8c", trend: "+8.2%" },
  { label: "Pelanggan Aktif (30d)", value: "842", color: "#b8860b", trend: "+12.5%" },
  { label: "Pelanggan Baru (30d)", value: "120", color: "#16a34a", trend: "+15.3%" },
    ...
    <div>
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Statistik Pelanggan</h1>
            <p className="text-sm text-gray-400 mt-1">Analisis mendalam metrik dan perilaku pelanggan</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8">
          ...
          <div className="space-y-3">
            {topCustomers.map((c, i) => (
              <div key={c.name} className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg transition-all">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400">{c.orders} pesanan · {toRp(c.spent)}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div className="h-2 bg-gradient-to-r from-blue-400 to-cyan-400" style={{ width: "65%" }} />
              </div>
            </div>
            <div>
              <div className="flex justify-between text-sm mb-2">
              ...
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div className="h-2 bg-gradient-to-r from-green-400 to-emerald-400" style={{ width: "55%" }} />
              </div>
            </div>
            <div>
              <div className="flex justify-between text-sm mb-2">
              ...
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div className="h-2 bg-gradient-to-r from-purple-400 to-pink-400" style={{ width: "39%" }} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8">
          <h2 className="font-bold text-lg mb-2 text-gray-800">Insights Pelanggan</h2>
          <p className="text-sm text-gray-400 mb-6">Rekomendasi dan saran actionable</p>

          <div className="space-y-4">
            <div className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg border border-green-100">
              <p className="text-xs font-bold text-green-700 mb-1">✓ Pertumbuhan Positif</p>
              <p className="text-xs text-green-600">Pelanggan baru naik 15.3% dalam 30 hari terakhir</p>
            </div>
            <div className="p-4 bg-gradient-to-br from-amber-50 to-yellow-50 rounded-lg border border-amber-100">
              ...
              <p className="text-xs text-amber-600">Tingkat retensi 39%, pertimbangkan program loyalitas</p>
            </div>
            <div className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg border border-blue-100">
              <p className="text-xs font-bold text-blue-700 mb-1">💡 Rekomendasi</p>
              <p className="text-xs text-blue-600">Fokus pada follow-up 5 pelanggan top untuk retention</p>
            </div>
          </div>
        </div>
      </div>
