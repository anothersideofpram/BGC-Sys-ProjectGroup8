...
export default function OrderPage() {
  ...
  const [form, setForm] = useState({
    nama: "", email: "", telepon: "", alamat: "", payment: "bank", catatan: "",
  });
  ...
  if (submitted) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <p className="text-sm mb-8" style={{ color: "#6b4a58" }}>
                        ...
                        <button
                          ...
                          className={`w-11 h-11 rounded-xl border text-sm font-semibold transition-all ${
                            item.size === s
                              ...
                              : "border-pink-200 text-gray-600 bg-white hover:border-pink-400"
                          }`}
                        >
                          {s}
                        </button>
          ...
          <div className="space-y-5">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <button
                    key={pay.id}
                    type="button"
                    onClick={() => setForm({ ...form, payment: pay.id })}
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl px-5 py-4 text-sm">
              ...
              <p style={{ color: "#7a5200" }}>
                {itemCount} item · estimasi <strong>{7 + itemCount * 2}–{10 + itemCount * 3} hari kerja</strong>
              </p>
            </div>
